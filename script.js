...
const translations = {
    es: {
        ...
        'company-info': 'La Palma de Oro<br>Artesanía y tradición en cada sombrero',
    ...
    en: {
        ...
        'company-info': 'La Palma de Oro<br>Artisanry and tradition in every hat',
    ...
    zh: {
        ...
        'company-info': 'La Palma de Oro<br>每顶帽子的工艺和传统',
        'quick-products': '产品',
